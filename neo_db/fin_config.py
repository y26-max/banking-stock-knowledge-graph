...
# 实体搜索器存储路径
entity_searcher_save_path = 'D:\本科毕业论文\参考材料\ShowKnowledge-main\ShowKnowledge-main\checkpoints\entity_searcher\search_tree.pkl'

# 实体搜索器加载路径
entity_searcher_load_path = 'D:\本科毕业论文\参考材料\ShowKnowledge-main\ShowKnowledge-main\checkpoints\entity_searcher\search_tree.pkl'
